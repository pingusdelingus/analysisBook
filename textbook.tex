...
\title{A Gentle Introduction to the Art of Analysis } % replace with the problem you are writing up
...
$\mid x^3 \mid < \frac{\epsilon}{2} \land \mid x^2 \mid < \frac{\epsilon}{2} \Leftarrow$
$ \mid x \mid < \sqrt[3]{\frac{\epsilon}{2}} \land  \mid x \mid < \sqrt[2]{\frac{\epsilon}{2}} $
and thus, we have shown that this limit is true if we define delta as the min of our two conjuncts\\
$  aksdjf;lkasdfj ;aklj$
